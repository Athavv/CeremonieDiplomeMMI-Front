...
const Guestbook = () => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-[#071341] overflow-x-hidden">
      <motion.div
        {...fadeUp}
        className="max-w-7xl mx-auto px-16 py-12 text-center md:text-left"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#071341] text-white py-4 uppercase tracking-[0.2em] hover:bg-[#B8AB38] hover:text-[#071341] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg font-medium text-sm mt-8 border border-[#071341]"
                >
                  Envoyer le message
                </button>
              </form>
          ...
          {messages.length > displayedMessages.length && (
            ...
            >
              <button
                ...
                className="inline-flex items-center gap-2 bg-transparent text-[#071341] border border-[#071341] px-8 py-3 uppercase tracking-widest hover:bg-[#071341] hover:text-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
              >
