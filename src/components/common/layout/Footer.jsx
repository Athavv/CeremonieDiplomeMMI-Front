      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            Cérémonie MMI Meaux– Outils et ressources pour célébrer la réussite
            des étudiants.
          </p>
        </div>
        ...
        <div className="text-center md:text-left uppercase">
          ...
          <ul className="flex flex-col gap-2 text-gray-300 text-sm">
            <li>
              <a
                href="https://maps.app.goo.gl/t4p21YTjWZiLXjCCA"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors"
              >
                ADRESSE : 4 Rue Cornillon, 77100 Meaux
              </a>
            </li>
            <li>
              <a
                href="tel:+33768058507"
                className="hover:text-white transition-colors"
              >
                TÉLÉPHONE : 07 68 05 85 07
              </a>
            </li>
          </ul>
        </div>
